...
<head>
    ...
    <title>Jhoan_ultengo_E_Ivan_molano</title>
</head>
...
<body>
    ...
    <div class="container">
    <h2>Jhoan_ultengo_E_Ivan_molano</h2>
    <h3>1022957746-1032393337</h3>
    <hr />

    <?php 
for($variable=0; $variable<=10; $variable++ ){
	echo "los_gafas ".$variable;
}
?> 
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">aqui estamos aprendiendo sobre como programamos una pagina web</p>
                        <a href="#" class="btn btn-primary">Ir al proyecto</a>
                    </div>
                </div>
            </div>
